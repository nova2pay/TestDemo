package com.pw.util.httpClient;
...
public class HttpProtocolHandler {
	...
	private int defaultSoTimeout = 50000;
	...
	public HttpResponse execute(HttpRequest request) {
		...
		try {
			...
			if (request.getResultType().equals(HttpResultType.STRING)) {
				response.setStringResult(IOUtils.toString(method.getResponseBodyAsStream(),"UTF-8"));
				
			} else if (request.getResultType().equals(HttpResultType.BYTES)) {
				response.setByteResult(IOUtils.toByteArray(method.getResponseBodyAsStream()));
			}
	 ...
	 * @return
	 */
	public HttpResponse execute(HttpRequest request, HttpMethod method) {
		HttpClient httpclient = new HttpClient(connectionManager);
		Protocol https = new Protocol("https", new SSLProtocolSocketFactory("TLS"), 443);   
		Protocol.registerProtocol("https", https);
