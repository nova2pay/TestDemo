...
<div>
				<a href="./fpglink.jsp"><input type="button" value="返回上一级"  style='width:200px;height:50px;background-color:green;border-radius:10px; outline:none;border:none;color:white;font-size:16px;letter-spacing:2px;margin:20px 0;display:block;'/></a>
			</div>
<div>
	<form action="pwto.jsp" method="post" target="_blank">
		<table id="formTable">
			<tr>
				<td class="col1"><span style="font-size:16px;">Payment Url(付款跳转地址):</span></td>
				<!-- <td><input id="gateway" name="gateway" type="text" size="79"
					value="http://test.zhdayue.com/payment/v3/checkOut.html?" /></td> -->
					<td>
								<select style='width:310px;height:35px;border-radius: 10px;outline: none;border:1px solid #000;padding-left:10px;' id="gateway" name="gateway">
									<option value="http://test-nms.nova2pay.com/payment/v3/checkOut.html">fpglink</option>
								</select>
					</td>
			</tr>
			<tr>
...
6uAk+SnzfpE=</textarea></td>
			...
			<tr>
				<td class="col1"><span style="font-size:16px;">CharSet(字符集):</span></td>
